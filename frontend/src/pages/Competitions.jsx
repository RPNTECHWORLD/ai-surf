  ...
  return (
    <div className="cmp-page">
      ...
      <style>{`
        ...
        .cmp-btn-register {
          width: 100%; padding: 10px 0; background: #0D9488; border-radius: 6px; border: none;
        ...
        /* Live Competition Card */
        .cmp-live-card {
          background: #050B1A; border: 1px solid #E2E8F0; box-shadow: 0px 8px 24px rgba(0,0,0,0.03);
          border-radius: 16px; padding: 40px; display: flex; flex-direction: column; gap: 32px;
        }
