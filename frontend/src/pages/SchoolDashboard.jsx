    ...
    <div className="db-page">
      ...
      <main className="db-main">
        <header className="db-header">
          <div>
            <h1 className="db-header-title">{school ? school.name : 'Dashboard'}</h1>
            <p className="db-header-sub">Good morning{school ? `, ${school.owner}` : ''} — here's what's happening today.</p>
          </div>
